...
import rectangle5 from '../assets/Rectangle 4@2x.png'
import rectangle6 from '../assets/Rectangle 5.png'
import rectangle7 from '../assets/Rectangle 6.png'

export default function WorksMini() {
  return (
    <div>
      <div className="flex justify-end gap-[50px] mr-[100px] mt-[50px]">
        <Link
          to="/works"
      ...
      <section>
        <div className="pl-[250px] gap-[20px]">
          ...
          <p className="font-medium text-2xl w-[800px] h-[93px] mt-[50px]">
            Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet
            sint. Velit officia consequat duis enim velit mollit. Exercitation
            veniam consequat sunt nostrud amet.
          </p>
          <img
            className="w-[980px] h-[560px]"
            src={rectangle5}
            alt="rectangle5"
          />
        </div>
        <div>
          <div className="mt-[100px] pl-[250px]">
            <h1>Heading 1</h1>
            <h3 className="mt-[20px]">Heading 2</h3>
          </div>
          <p className="font-medium text-2xl w-[800px] h-[93px] mt-[50px] ml-[250px]">
            Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet
            sint. Velit officia consequat duis enim velit mollit. Exercitation
            veniam consequat sunt nostrud amet.
          </p>
          <img
            className="w-[980px] h-[560px] ml-[250px]"
            src={rectangle6}
            alt="rectangle6"
          />
          <img
            className="w-[980px] h-[560px] ml-[250px] mt-[50px]"
            src={rectangle7}
            alt="rectangle7"
          />
        </div>
