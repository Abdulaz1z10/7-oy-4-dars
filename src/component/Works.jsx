...
import rectangle4 from '../assets/Rectangle 40.png'
    ...
    <div className="container">
      ...
      <section>
        <div className="pl-[100px] gap-[20px]">
          ...
          <div className="mt-[50px]">
            <div className="w-[900px] h-[230px]">
              <div className="flex w-[860px] h-[180px]">
                ...
                <div>
                  <Link
                    to="/works_mini"
                    className="w-[300px] h-[34px] ml-[18px] font-bold text-3xl no-underline text-black"
                  >
            ...
            <div className=" mb-[50px] w-[1100px] h-[2px] border-solid border-2 border-slate-400 "></div>
            <div className="w-[900px] h-[230px]">
              <div className="flex w-[860px] h-[180px]">
      ...
      <footer>
        <div className="w-[1100px] h-[200px]">
          ...
          <div className="flex pl-[520px] mt-[30px]">
