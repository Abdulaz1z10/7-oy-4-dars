...
export default function Blog() {
  return (
    <div className="container">
      ...
      <section>
        <div className="pl-[100px] gap-[20px]">
          <div className="mt-[100px] ">
            <h1>Blog</h1>
          </div>
          <div className="mt-[55px]">
            <p className="w-[680px] h-[35px] text-4xl font-semibold">
              UI Interactions of the week
            </p>
            <div className="flex gap-[30px]">
              <p className="text-2xl font-medium text-slate-950">12 Feb 2019</p>
              <p className="text-2xl font-medium">|</p>
              <p className="text-2xl font-medium text-slate-500">
                Express, Handlebars
              </p>
            </div>
            <p className="w-[680px] h-[45px] text-xl font-medium">
              Amet minim mollit non deserunt ullamco est sit aliqua dolor do
              amet sint. Velit officia consequat duis enim velit mollit.
              Exercitation veniam consequat sunt nostrud amet.
            </p>
          </div>
          <div className=" mt-[40px] w-[1100px] h-[2px] border-solid border-2 border-slate-400 "></div>
          <div className="mt-[55px]">
            <p className="w-[680px] h-[35px] text-4xl font-semibold">
              UI Interactions of the week
            </p>
      ...
      <footer>
        <div className="w-[1100px] h-[200px]">
          <div className="flex gap-[20px] pl-[550px] pt-[50px]">
            <svg
          ...
          <div className="flex pl-[530px] mt-[30px]">
